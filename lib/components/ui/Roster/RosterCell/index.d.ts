...
export interface RosterCellProps extends BaseProps, FocusableProps, Tooltipable {
...
export declare const RosterCell: React.FC<React.PropsWithChildren<RosterCellProps>>;
