...
export type ControlBarLayout = 'top' | 'bottom' | 'right' | 'left' | 'undocked-horizontal' | 'undocked-vertical';
...
export declare const ControlBar: FC<React.PropsWithChildren<ControlBarProps>>;
